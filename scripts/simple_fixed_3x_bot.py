#!/usr/bin/env python3
"""
Simple Fixed 3x - Scaling Factor: 3.0x
Capital: 28.95 USDT
"""
...
class ScaledBot:
    def __init__(self):
        self.name = "Simple Fixed 3x"
        self.capital = 28.95
        self.position_size = 0.45
        self.frequency = 300
        self.symbols = ['ADAUSDT', 'BTCUSDT', 'ETHUSDT']
        self.scaling = 3.0
        
        self.db_path = Path(__file__).parent.parent / "data" / "databases" / f"simple_fixed_3x_trades.db"
