#!/usr/bin/env python3
"""
AurumBotX Strategy Bot: Momentum_Rider
Specialized bot for momentum_rider strategy

Auto-generated: 2025-09-14T03:24:00.639890
"""
...
class MomentumRiderBot:
    def __init__(self):
        self.strategy_key = "momentum_rider"
        self.strategy_name = "Momentum_Rider"
        self.config_path = project_root / "config" / f"strategy_momentum_rider.json"
        self.db_path = project_root / "data" / "databases" / f"momentum_rider_trades.db"
    ...
    def calculate_position_size(self, confidence):
        ...
        strategy_mult = strategy_multipliers.get("momentum_rider", 1.0)
