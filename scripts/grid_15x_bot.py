#!/usr/bin/env python3
"""
Grid Trading 1.5x - Scaling Factor: 1.5x
Capital: 11.58 USDT
"""
...
class ScaledBot:
    def __init__(self):
        self.name = "Grid Trading 1.5x"
        self.capital = 11.58
        self.position_size = 0.35
        self.frequency = 600
        self.symbols = ['DOTUSDT', 'BTCUSDT']
        self.scaling = 1.5
        
        self.db_path = Path(__file__).parent.parent / "data" / "databases" / f"grid_15x_trades.db"
