                ...
                with st.container():
                    st.markdown(f"""
                        <div class="metric-card">
                            <h3>Current Price</h3>
                            <p class="big-metric">${current_price:.2f}</p>
                            <p class="metric-change {'positive' if price_change > 0 else 'negative'}>{price_change:.2%}</p>
                        </div>
            ...
            with col2:
                with st.container():
                    st.markdown(f"""
                        <div class="metric-card">
                            <h3>24h Volume</h3>
                            <p class="big-metric">${df['Volume'].iloc[-1]:,.0f}</p>
                        </div>
                        """, unsafe_allow_html=True)
            ...
            with col3:
                with st.container():
                    st.markdown(f"""
                        <div class="metric-card">
                            <h3>RSI</h3>
                            <p class="big-metric">{df['RSI'].iloc[-1]:.2f}</p>
                        </div>
                        """, unsafe_allow_html=True)
            ...
            with col4:
                with st.container():
                    st.markdown(f"""
                        <div class="metric-card">
                            <h3>MACD</h3>
                            <p class="big-metric">{df['MACD'].iloc[-1]:.2f}</p>
                        </div>
                        """, unsafe_allow_html=True)
